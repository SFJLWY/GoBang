...
void GameNetWindow::paintEvent(QPaintEvent *)
{
    ...
    QPixmap backgroundPic_loong(QString(":/images/background-loong.jpg"));
    QPixmap backgroundPic_Yangpizhi(QString(":/images/background-Yangpizhi.jpg"));
    ...
    case 1:
        ...
        break;
    case 2:
        painter.drawPixmap(20,40,600,600,backgroundPic_loong);
        break;
    case 3:
        painter.drawPixmap(20,40,600,600,backgroundPic_Yangpizhi);
        break;
    }
    /*
    //调节棋盘颜色
